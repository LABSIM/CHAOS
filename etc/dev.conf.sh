...
UTILITIES_ROOT=$DEV_HOME/Utilities/$DEV_SUBDIR
...
PROPTREE_ROOT=$DEV_HOME/propTree/$DEV_SUBDIR
...
ELIPS_INCLUDEDIR="${ELIPS_ROOT}/build $(find -L ${ELIPS_ROOT}/include/ -type d | grep -v svn | grep -v VTB_QT)"
