...
declare LABSIM_COMMON_MASK=$(( 1 << 0 ))
declare LABSIM_COLOSSES_MASK=$(( 1 << 1 ))
declare LABSIM_OLYMPIENS_MASK=$(( 1 << 2 ))
declare LABSIM_TITANS_MASK=$(( 1 << 3 ))
declare LABSIM_CONTRACT_MASK=$(( 1 << 4 ))
