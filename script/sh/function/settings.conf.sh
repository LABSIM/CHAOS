...
if [ "${GAIA_FOUND_DSI_HOST}" = true ]; then
	...
	#
	# ADD --> will be unloaded if by corresponding third_paty dependancies
	#
...
export GAIA_THIRD_PARTY_HOME GAIA_DEV_HOME BDD_HOME GAIA_CONTRACT_HOME GAIA_COLOSSES_HOME GAIA_OLYMPIENS_HOME GAIA_TITANS_HOME
