...
if [ "${GAIA_THIRD_PARTY_LIBEV_FOUND}" = true ]; then
	...
	# env
	CPATH=$GAIA_THIRD_PARTY_LIBEV_INCLUDEDIR${CPATH:+:${CPATH}}
	LD_LIBRARY_PATH=$GAIA_THIRD_PARTY_LIBEV_LIBRARYDIR${LD_LIBRARY_PATH:+:${LD_LIBRARY_PATH}}
...
if [ "${GAIA_THIRD_PARTY_NGHTTP2_FOUND}" = true ]; then
	...
	# env
	CPATH=$GAIA_THIRD_PARTY_NGHTTP2_INCLUDEDIR${CPATH:+:${CPATH}}
	PATH=$GAIA_THIRD_PARTY_NGHTTP2_BINARYDIR${PATH:+:${PATH}}
	LD_LIBRARY_PATH=$GAIA_THIRD_PARTY_NGHTTP2_LIBRARYDIR${LD_LIBRARY_PATH:+:${LD_LIBRARY_PATH}}
	PKG_CONFIG_PATH=$GAIA_THIRD_PARTY_NGHTTP2_LIBRARYDIR/pkgconfig${PKG_CONFIG_PATH:+:${PKG_CONFIG_PATH}}
...
if [ "${GAIA_THIRD_PARTY_GSOAP_FOUND}" = true ]; then
	...
	# env
	CPATH=$GAIA_THIRD_PARTY_GSOAP_INCLUDEDIR${CPATH:+:${CPATH}}
	PATH=$GAIA_THIRD_PARTY_GSOAP_BINARYDIR${PATH:+:${PATH}}
	LD_LIBRARY_PATH=$GAIA_THIRD_PARTY_GSOAP_LIBRARYDIR${LD_LIBRARY_PATH:+:${LD_LIBRARY_PATH}}
	PKG_CONFIG_PATH=$GAIA_THIRD_PARTY_GSOAP_LIBRARYDIR/pkgconfig${PKG_CONFIG_PATH:+:${PKG_CONFIG_PATH}}
