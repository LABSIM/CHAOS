...
if [ "${GAIA_THIRD_PARTY_GDAL_FOUND}" = true ]; then
	...
	# env
	CPATH=$GAIA_THIRD_PARTY_GDAL_INCLUDEDIR${CPATH:+:${CPATH}}
	PATH=$GAIA_THIRD_PARTY_GDAL_BINARYDIR${PATH:+:${PATH}}
	LD_LIBRARY_PATH=$GAIA_THIRD_PARTY_GDAL_LIBRARYDIR${LD_LIBRARY_PATH:+:${LD_LIBRARY_PATH}}
	PKG_CONFIG_PATH=$GAIA_THIRD_PARTY_GDAL_LIBRARYDIR/pkgconfig${PKG_CONFIG_PATH:+:${PKG_CONFIG_PATH}}
	...
	# export
	export GDAL_DATA=$GAIA_THIRD_PARTY_GDAL_ROOT/share/gdal
...
if [ "${GAIA_THIRD_PARTY_GEOS_FOUND}" = true ]; then
	...
	# env
	CPATH=$GAIA_THIRD_PARTY_GEOS_INCLUDEDIR${CPATH:+:${CPATH}}
	PATH=$GAIA_THIRD_PARTY_GEOS_BINARYDIR${PATH:+:${PATH}}
	LD_LIBRARY_PATH=$GAIA_THIRD_PARTY_GEOS_LIBRARYDIR${LD_LIBRARY_PATH:+:${LD_LIBRARY_PATH}}
...
if [ "${GAIA_THIRD_PARTY_FFTSS_FOUND}" = true ]; then
	...
	# env
	CPATH=$GAIA_THIRD_PARTY_FFTSS_INCLUDEDIR${CPATH:+:${CPATH}}
	PATH=$GAIA_THIRD_PARTY_FFTSS_BINARYDIR${PATH:+:${PATH}}
	LD_LIBRARY_PATH=$GAIA_THIRD_PARTY_FFTSS_LIBRARYDIR${LD_LIBRARY_PATH:+:${LD_LIBRARY_PATH}}
...
if [ "${GAIA_THIRD_PARTY_OPENSCENEGRAPH_FOUND}" = true ]; then
	...
	CPATH=$GAIA_THIRD_PARTY_OPENSCENEGRAPH_INCLUDEDIR${CPATH:+:${CPATH}}
	PATH=$GAIA_THIRD_PARTY_OPENSCENEGRAPH_BINARYDIR${PATH:+:${PATH}}
	LD_LIBRARY_PATH=$GAIA_THIRD_PARTY_OPENSCENEGRAPH_LIBRARYDIR${LD_LIBRARY_PATH:+:${LD_LIBRARY_PATH}}
	...
	# export
	export OSG_DIR=$GAIA_THIRD_PARTY_OPENSCENEGRAPH_ROOT
	export OSG_NOTIFY_LEVEL=NOTICE
	export OSG_OPTIMIZER="DEFAULT ~MAKE_FAST_GEOMETRY"
...
if [ "${GAIA_THIRD_PARTY_SILVERLINING_FOUND}" = true ]; then
	...
	# env
	CPATH=$GAIA_THIRD_PARTY_SILVERLINING_INCLUDEDIR${CPATH:+:${CPATH}}
	LD_LIBRARY_PATH=$GAIA_THIRD_PARTY_SILVERLINING_LIBRARYDIR${LD_LIBRARY_PATH:+:${LD_LIBRARY_PATH}}
	...
	# export
	export SILVERLINING_DIR=$GAIA_THIRD_PARTY_SILVERLINING_ROOT
	export SILVERLINING_PATH=$GAIA_THIRD_PARTY_SILVERLINING_ROOT/Resources
...
if [ "${GAIA_THIRD_PARTY_TRITON_FOUND}" = true ]; then
	...
	# env
	CPATH=$GAIA_THIRD_PARTY_TRITON_INCLUDEDIR${CPATH:+:${CPATH}}
	LD_LIBRARY_PATH=$GAIA_THIRD_PARTY_TRITON_LIBRARYDIR${LD_LIBRARY_PATH:+:${LD_LIBRARY_PATH}}
	# CPATH=$GAIA_THIRD_PARTY_TRITON_INCLUDEDIR:$CPATH
	# LD_LIBRARY_PATH=$GAIA_THIRD_PARTY_TRITON_LIBRARYDIR:$LD_LIBRARY_PATH

	# export
	export TRITON_DIR=$GAIA_THIRD_PARTY_TRITON_ROOT
	export TRITON_PATH=$GAIA_THIRD_PARTY_TRITON_ROOT/Resources
