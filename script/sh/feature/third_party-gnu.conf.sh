...
if [ "${GAIA_THIRD_PARTY_LIBTOOL_FOUND}" = true ]; then
	...
	# env
	CPATH=$GAIA_THIRD_PARTY_LIBTOOL_INCLUDEDIR${CPATH:+:${CPATH}}
	PATH=$GAIA_THIRD_PARTY_LIBTOOL_BINARYDIR${PATH:+:${PATH}}
	LD_LIBRARY_PATH=$GAIA_THIRD_PARTY_LIBTOOL_LIBRARYDIR${LD_LIBRARY_PATH:+:${LD_LIBRARY_PATH}}
...
if [ "${GAIA_THIRD_PARTY_LIBUNISTRING_FOUND}" = true ]; then
	...
	# env
	CPATH=$GAIA_THIRD_PARTY_LIBUNISTRING_INCLUDEDIR${CPATH:+:${CPATH}}
	LD_LIBRARY_PATH=$GAIA_THIRD_PARTY_LIBUNISTRING_LIBRARYDIR${LD_LIBRARY_PATH:+:${LD_LIBRARY_PATH}}
...
if [ "${GAIA_THIRD_PARTY_GC_FOUND}" = true ]; then
	...
	# env
	CPATH=$GAIA_THIRD_PARTY_GC_INCLUDEDIR${CPATH:+:${CPATH}}
	LD_LIBRARY_PATH=$GAIA_THIRD_PARTY_GC_LIBRARYDIR${LD_LIBRARY_PATH:+:${LD_LIBRARY_PATH}}
	PKG_CONFIG_PATH=$GAIA_THIRD_PARTY_GC_LIBRARYDIR/pkgconfig${PKG_CONFIG_PATH:+:${PKG_CONFIG_PATH}}
...
if [ "${GAIA_THIRD_PARTY_GMP_FOUND}" = true ]; then
	...
	# env
	CPATH=$GAIA_THIRD_PARTY_GMP_INCLUDEDIR${CPATH:+:${CPATH}}
	LD_LIBRARY_PATH=$GAIA_THIRD_PARTY_GMP_LIBRARYDIR${LD_LIBRARY_PATH:+:${LD_LIBRARY_PATH}}
	PKG_CONFIG_PATH=$GAIA_THIRD_PARTY_GMP_LIBRARYDIR/pkgconfig${PKG_CONFIG_PATH:+:${PKG_CONFIG_PATH}}
	# CPATH=$GAIA_THIRD_PARTY_GMP_INCLUDEDIR:$CPATH
	# LD_LIBRARY_PATH=$GAIA_THIRD_PARTY_GMP_LIBRARYDIR:$LD_LIBRARY_PATH
	# PKG_CONFIG_PATH=$GAIA_THIRD_PARTY_GMP_LIBRARYDIR/pkgconfig:$PKG_CONFIG_PATH
...
if [ "${GAIA_THIRD_PARTY_GUILE_FOUND}" = true ]; then
	...
	# env
	CPATH=$GAIA_THIRD_PARTY_GUILE_INCLUDEDIR${CPATH:+:${CPATH}}
	PATH=$GAIA_THIRD_PARTY_GUILE_BINARYDIR${PATH:+:${PATH}}
	LD_LIBRARY_PATH=$GAIA_THIRD_PARTY_GUILE_LIBRARYDIR${LD_LIBRARY_PATH:+:${LD_LIBRARY_PATH}}
	PKG_CONFIG_PATH=$GAIA_THIRD_PARTY_GUILE_LIBRARYDIR/pkgconfig${PKG_CONFIG_PATH:+:${PKG_CONFIG_PATH}}
...
if [ "${GAIA_THIRD_PARTY_BINUTILS_FOUND}" = true ]; then
	...
	# env
	CPATH=$GAIA_THIRD_PARTY_BINUTILS_INCLUDEDIR${CPATH:+:${CPATH}}
	PATH=$GAIA_THIRD_PARTY_BINUTILS_BINARYDIR${PATH:+:${PATH}}
	LD_LIBRARY_PATH=$GAIA_THIRD_PARTY_BINUTILS_LIBRARYDIR${LD_LIBRARY_PATH:+:${LD_LIBRARY_PATH}}
...
if [ "${GAIA_THIRD_PARTY_MPC_FOUND}" = true ]; then
	...
	# env
	CPATH=$GAIA_THIRD_PARTY_MPC_INCLUDEDIR${CPATH:+:${CPATH}}
	LD_LIBRARY_PATH=$GAIA_THIRD_PARTY_MPC_LIBRARYDIR${LD_LIBRARY_PATH:+:${LD_LIBRARY_PATH}}
...
if [ "${GAIA_THIRD_PARTY_MPFR_FOUND}" = true ]; then
	...
	# env
	CPATH=$GAIA_THIRD_PARTY_MPFR_INCLUDEDIR${CPATH:+:${CPATH}}
	LD_LIBRARY_PATH=$GAIA_THIRD_PARTY_MPFR_LIBRARYDIR${LD_LIBRARY_PATH:+:${LD_LIBRARY_PATH}}
...
if [ "${GAIA_THIRD_PARTY_AUTOGEN_FOUND}" = true ]; then
	...
	# env
	CPATH=$GAIA_THIRD_PARTY_AUTOGEN_INCLUDEDIR${CPATH:+:${CPATH}}
	PATH=$GAIA_THIRD_PARTY_AUTOGEN_BINARYDIR${PATH:+:${PATH}}
	LD_LIBRARY_PATH=$GAIA_THIRD_PARTY_AUTOGEN_LIBRARYDIR${LD_LIBRARY_PATH:+:${LD_LIBRARY_PATH}}
...
if [ "${GAIA_THIRD_PARTY_ISL_FOUND}" = true ]; then
	...
	# env
	CPATH=$GAIA_THIRD_PARTY_ISL_INCLUDEDIR${CPATH:+:${CPATH}}
	LD_LIBRARY_PATH=$GAIA_THIRD_PARTY_ISL_LIBRARYDIR${LD_LIBRARY_PATH:+:${LD_LIBRARY_PATH}}
...
if [ "${GAIA_THIRD_PARTY_GCC_FOUND}" = true ]; then
	...
	GAIA_THIRD_PARTY_GCC_MULTILIB_INCLUDEDIR=$GAIA_THIRD_PARTY_GCC_INCLUDEDIR/x86_64-pc-linux-gnu
	...
	CPATH=$GAIA_THIRD_PARTY_GCC_INCLUDEDIR:GAIA_THIRD_PARTY_GCC_MULTILIB_INCLUDEDIR${CPATH:+:${CPATH}}
	PATH=$GAIA_THIRD_PARTY_GCC_BINARYDIR:$GAIA_THIRD_PARTY_GCC_LIBRARYEXECDIR${PATH:+:${PATH}}
	LD_LIBRARY_PATH=$GAIA_THIRD_PARTY_GCC_LIBRARYDIR:$GAIA_THIRD_PARTY_GCC_LIBRARY64DIR${LD_LIBRARY_PATH:+:${LD_LIBRARY_PATH}}
...
if [ "${GAIA_THIRD_PARTY_GDB_FOUND}" = true ]; then
	...
	# env
	CPATH=$GAIA_THIRD_PARTY_GDB_INCLUDEDIR${CPATH:+:${CPATH}}
	PATH=$GAIA_THIRD_PARTY_GDB_BINARYDIR${PATH:+:${PATH}}
	LD_LIBRARY_PATH=$GAIA_THIRD_PARTY_GDB_LIBRARYDIR${LD_LIBRARY_PATH:+:${LD_LIBRARY_PATH}}
...
if [ "${GAIA_THIRD_PARTY_MAKE_FOUND}" = true ]; then
	...
	# env
	CPATH=$GAIA_THIRD_PARTY_MAKE_INCLUDEDIR${CPATH:+:${CPATH}}
	PATH=$GAIA_THIRD_PARTY_MAKE_BINARYDIR${PATH:+:${PATH}}
	LD_LIBRARY_PATH=$GAIA_THIRD_PARTY_MAKE_LIBRARYDIR${LD_LIBRARY_PATH:+:${LD_LIBRARY_PATH}}
