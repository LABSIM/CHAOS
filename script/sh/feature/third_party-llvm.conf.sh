...
if [ "${GAIA_THIRD_PARTY_LLVM_FOUND}" = true ]; then
	...
	# env
	CPATH=$GAIA_THIRD_PARTY_LLVM_INCLUDEDIR${CPATH:+:${CPATH}}
	PATH=$GAIA_THIRD_PARTY_LLVM_BINARYDIR${PATH:+:${PATH}}
	LD_LIBRARY_PATH=$GAIA_THIRD_PARTY_LLVM_LIBRARYDIR${LD_LIBRARY_PATH:+:${LD_LIBRARY_PATH}}	
	...
	# export
	export LLVM_INSTALL_DIR=$GAIA_THIRD_PARTY_LLVM_ROOT
