...
if [ "${GAIA_THIRD_PARTY_CEGUI_FOUND}" = true ]; then

	# internal
	GAIA_THIRD_PARTY_CEGUI_ROOT=$GAIA_THIRD_PARTY_HOME/cegui-$GAIA_THIRD_PARTY_CEGUI_VERSION
	GAIA_THIRD_PARTY_CEGUI_BINARYDIR=$GAIA_THIRD_PARTY_CEGUI_ROOT/bin
	GAIA_THIRD_PARTY_CEGUI_LIBRARYDIR=$GAIA_THIRD_PARTY_CEGUI_ROOT/lib
	GAIA_THIRD_PARTY_CEGUI_INCLUDEDIR=$GAIA_THIRD_PARTY_CEGUI_ROOT/include

	# info
	GAIA_DISTRIBUTION_DETAIL="$GAIA_DISTRIBUTION_DETAIL\n\t|\t* CEGui v.$GAIA_THIRD_PARTY_CEGUI_VERSION"

	# env
	CPATH=$GAIA_THIRD_PARTY_CEGUI_INCLUDEDIR:$CPATH
	PATH=$GAIA_THIRD_PARTY_CEGUI_BINARYDIR:$PATH
	LD_LIBRARY_PATH=$GAIA_THIRD_PARTY_CEGUI_LIBRARYDIR:$LD_LIBRARY_PATH

	# clean
	unset GAIA_THIRD_PARTY_CEGUI_ROOT
	unset GAIA_THIRD_PARTY_CEGUI_LIBRARYDIR
	unset GAIA_THIRD_PARTY_CEGUI_INCLUDEDIR
	unset GAIA_THIRD_PARTY_CEGUI_BINARYDIR
...
###
#
#CEED_ROOT=$THIRD_PARTY_HOME/ceed-$CEED_VERSION
