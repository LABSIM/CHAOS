...
if [ "${GAIA_THIRD_PARTY_QT_FOUND}" = true ]; then
	...
	# env
	CPATH=$GAIA_THIRD_PARTY_QT_INCLUDEDIR${CPATH:+:${CPATH}}
	PATH=$GAIA_THIRD_PARTY_QT_BINARYDIR${PATH:+:${PATH}}
	LD_LIBRARY_PATH=$GAIA_THIRD_PARTY_QT_LIBRARYDIR${LD_LIBRARY_PATH:+:${LD_LIBRARY_PATH}}
	...
	# export
	export QTDIR=$GAIA_THIRD_PARTY_QT_ROOT
	export QTINC=$GAIA_THIRD_PARTY_QT_INCLUDEDIR
	export QTLIB=$GAIA_THIRD_PARTY_QT_LIBRARYDIR
...
if [ "${GAIA_THIRD_PARTY_QTCREATOR_FOUND}" = true ]; then
	...
	# internal
	GAIA_THIRD_PARTY_QTCREATOR_ROOT=$GAIA_THIRD_PARTY_HOME/qtcreator-$GAIA_THIRD_PARTY_QTCREATOR_VERSION
	...
	# env
	CPATH=$GAIA_THIRD_PARTY_QTCREATOR_BINARYDIR${CPATH:+:${CPATH}}
	LD_LIBRARY_PATH=$GAIA_THIRD_PARTY_QTCREATOR_LIBRARYDIR${LD_LIBRARY_PATH:+:${LD_LIBRARY_PATH}}
