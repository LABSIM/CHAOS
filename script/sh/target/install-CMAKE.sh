...
###~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~##
#
# PUSH_MODULE_OP_TO_CACHE FUNCTION
#
###~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~##

function push_module_op_to_cache() {

	# print
	echo -ne "  + Copie des fichiers CMakeModule specifiques (COTIRE,gRPC) pour ${GAIA_TARGET_PRETTY_NAME} ${GAIA_TARGET_VERSION}..."
