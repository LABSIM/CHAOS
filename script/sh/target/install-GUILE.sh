...
function push_configure_op_to_cache() {
	...
	# the op
	echo "#!/bin/bash" > exec.sh
	echo "./configure CPPFLAGS='-I${GAIA_THIRD_PARTY_HOME}/libtool-${GAIA_THIRD_PARTY_LIBTOOL_VERSION}/include -I${GAIA_THIRD_PARTY_HOME}/libunistring-${GAIA_THIRD_PARTY_LIBUNISTRING_VERSION}/include' LDFLAGS='-L${GAIA_THIRD_PARTY_HOME}/libtool-${GAIA_THIRD_PARTY_LIBTOOL_VERSION}/lib -L${GAIA_THIRD_PARTY_HOME}/libunistring-${GAIA_THIRD_PARTY_LIBUNISTRING_VERSION}/lib' --prefix=${GAIA_THIRD_PARTY_HOME}/${GAIA_TARGET_LC_NAME}-${GAIA_TARGET_VERSION}" >> exec.sh
