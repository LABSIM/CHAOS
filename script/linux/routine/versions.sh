...
OSVR_DISPLAY_MAJ_VER=0
OSVR_DISPLAY_MIN_VER=0
OSVR_DISPLAY_PATCH_VER=0 
OSVR_DISPLAY_VERSION=0
...
split_version "osvr-display" OSVR_DISPLAY_MAJ_VER OSVR_DISPLAY_MIN_VER OSVR_DISPLAY_PATCH_VER OSVR_DISPLAY_VERSION
split_version "go" GO_MAJ_VER GO_MIN_VER GO_PATCH_VER GO_VERSION
split_version "protobuf" PROTOBUF_MAJ_VER PROTOBUF_MIN_VER PROTOBUF_PATCH_VER PROTOBUF_VERSION
split_version "grpc" GRPC_MAJ_VER GRPC_MIN_VER GRPC_PATCH_VER GRPC_VERSION
