...
#OSVR_DISPLAY_ROOT=$PRO_HOME/osvr-display-$OSVR_DISPLAY_VERSION
#OSVR_DISPLAY_LIBRARYDIR=$OSVR_DISPLAY_ROOT/lib64
#OSVR_DISPLAY_INCLUDEDIR=$OSVR_DISPLAY_ROOT/include
#OSVR_DISPLAY_BINARYDIR=$OSVR_DSIPLAY_ROOT/bin

#export OSVR_DISPLAY_ROOT OSVR_DISPLAY_INCLUDEDIR OSVR_DISPLAY_LIBRARYDIR OSVR_DISPLAY_BINARYDIR

###################################################################
# GO
###

GOROOT=$PRO_HOME/go-$GO_VERSION
...
PROTOBUF_ROOT=$PRO_HOME/protobuf-$PROTOBUF_VERSION
PROTOBUF_LIBRARYDIR=$PROTOBUF_ROOT/lib
PROTOBUF_INCLUDEDIR=$PROTOBUF_ROOT/include
PROTOBUF_BINARYDIR=$PROTOBUF_ROOT/bin

export PROTOBUF_ROOT PROTOBUF_INCLUDEDIR PROTOBUF_LIBRARYDIR PROTOBUF_BINARYDIR

###################################################################
# GRPC
###

GRPC_ROOT=$PRO_HOME/grpc-$GRPC_VERSION
GRPC_LIBRARYDIR=$GRPC_ROOT/lib
GRPC_INCLUDEDIR=$GRPC_ROOT/include
GRPC_BINARYDIR=$GRPC_ROOT/bin

export GRPC_ROOT GRPC_INCLUDEDIR GRPC_LIBRARYDIR GRPC_BINARYDIR
...
GAIA_DEV_DIST="$GAIA_DEV_DIST\n\t|\t* osvr-display v.$OSVR_DISPLAY_VERSION"
GAIA_DEV_DIST="$GAIA_DEV_DIST\n\t|\t* go v.$GO_VERSION"
GAIA_DEV_DIST="$GAIA_DEV_DIST\n\t|\t* protobuf v.$PROTOBUF_VERSION"
GAIA_DEV_DIST="$GAIA_DEV_DIST\n\t|\t* grpc v.$GRPC_VERSION"
...
PKG_CONFIG_PATH=$PROTOBUF_LIBRARYDIR/pkgconfig:$GRPC_LIBRARYDIR/pkgconfig
#:$PKG_CONFIG_PATH
...
PKG_CONFIG_PATH=$GRPC_LIBRARYDIR/pkgconfig:$PROTOBUF_LIBRARYDIR/pkgconfig
#:$PKG_CONFIG_PATH

fi # DRI ?

export CPATH PATH LD_LIBRARY_PATH PKG_CONFIG_PATH
