...
SILVERLINING_INCLUDE_DIR=$SILVERLINING_INCLUDEDIR
SILVERLINING_LIBRARY_DEBUG=$SILVERLINING_LIBRARYDIR
SILVERLINING_LIBRARY_RELEASE=$SILVERLINING_LIBRARYDIR

export SILVERLINING_ROOT SILVERLINING_INCLUDEDIR SILVERLINING_LIBRARYDIR SILVERLINING_INCLUDE_DIR SILVERLINING_LIBRARY_DEBUG SILVERLINING_LIBRARY_RELEASE
...
TRITON_INCLUDE_DIR=$TRITON_INCLUDEDIR
TRITON_LIBRARY_DEBUG=$TRITON_LIBRARYDIR
TRITON_LIBRARY_RELEASE=$TRITON_LIBRARYDIR

export TRITON_ROOT TRITON_INCLUDEDIR TRITON_LIBRARYDIR TRITON_INCLUDE_DIR TRITON_LIBRARY_DEBUG TRITON_LIBRARY_RELEASE
