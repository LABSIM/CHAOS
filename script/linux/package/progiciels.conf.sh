...
export SILVERLINING_ROOT SILVERLINING_INCLUDEDIR SILVERLINING_LIBRARYDIR SILVERLINING_PATH
...
export TRITON_ROOT TRITON_INCLUDEDIR TRITON_LIBRARYDIR TRITON_PATH
