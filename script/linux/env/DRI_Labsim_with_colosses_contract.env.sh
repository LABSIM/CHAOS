...
##############################################################################
## Colosses/Contract LABSIM Development Environment config					##	
##																			##
...
export LABSIM_DEV_ID=$(( $LABSIM_DRI_MASK ^ $LABSIM_COMMON_MASK ^ $LABSIM_COLOSSES_MASK ^ $LABSIM_CONTRACT_MASK ))
