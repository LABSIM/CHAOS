...
##############################################################################
## All LABSIM Development Environment config								##	
##																			##
...
export LABSIM_DEV_ID=$(( $LABSIM_DRI_MASK ^ $LABSIM_COMMON_MASK ^ $LABSIM_COLOSSES_MASK ^ $LABSIM_OLYMPIENS_MASK ^ $LABSIM_TITANS_MASK ))
