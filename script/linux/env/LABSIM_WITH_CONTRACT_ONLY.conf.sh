...
##############################################################################
## CONTRACT ONLY LABSIM Development Environment config						##	
##																			##
...
export DEV_CURRENT_DIST="Contract Only LABSIM Development Environment config"
export DEV_CURRENT_ID=0x05
