...
##############################################################################
## Contract/Titans LABSIM Development Environment config					##	
##																			##
...
export DEV_CURRENT_DIST="Contract/Titans LABSIM Development Environment config"
export DEV_CURRENT_ID=0x08
