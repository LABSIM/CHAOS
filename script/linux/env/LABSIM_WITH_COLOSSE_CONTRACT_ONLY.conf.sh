...
##############################################################################
## Colosse/Contract LABSIM Development Environment config					##	
##																			##
...
export DEV_CURRENT_DIST="Colosse/Contract LABSIM Development Environment config"
export DEV_CURRENT_ID=0x07
